...
export const contentBacklogSources = ['signal_brief', 'create', 'manual', 'insights', 'assistant', 'session_planner'] as const;
...
const serviceEstimateByName: Record<string, number> = {
  ...
  'cv + linkedin bundle': 450,
  'cv and linkedin bundle': 450,
