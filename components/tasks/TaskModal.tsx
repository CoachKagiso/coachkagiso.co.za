...
export function TaskModal({
  ...
  return (
    ...
    >
      <section
        className={`task-modal-panel flex h-[92vh] max-h-[92vh] w-full flex-col overflow-hidden rounded-t-[16px] bg-white shadow-[0_20px_60px_rgba(0,0,0,0.15)] md:h-[92vh] md:max-h-[860px] md:w-[640px] md:rounded-[16px] ${
