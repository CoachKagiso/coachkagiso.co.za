          ...
          <div>
            ...
            <div className="mt-5 grid gap-4">
              ...
              <div className="flex gap-3 pt-2">
                ...
                <a href="https://www.facebook.com/coachkagisoSA" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="h-10 w-10 rounded-full border border-white/20 flex items-center justify-center text-white/80 hover:border-[#C9AD98] hover:text-[#C9AD98] transition">
