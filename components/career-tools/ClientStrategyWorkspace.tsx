...
export default function ClientStrategyWorkspace({
  ...
  useEffect(() => {
    if (!selectedClient || !hasStrategyTab || activeTab !== 'strategy') {
  ...
  }, [activeTab, adminKey, hasStrategyTab, selectedClient]);
          ...
          <div className="min-w-0">
            ...
            >
              {visibleTab === 'context' ? (
                ...
                <div className="grid gap-4 2xl:grid-cols-[minmax(0,0.95fr)_minmax(0,1.05fr)] 2xl:items-start">
