-- Allow the SA CV Checklist lead magnet as a lead source on submissions and email templates.
...
alter table public.diagnostic_submissions
  ...
  check (source in ('diagnostic', 'first_90_days', 'linkedin_headline', 'cv_checklist', 'masterclass_waitlist'));
